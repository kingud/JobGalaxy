<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="recruiter_login.aspx.cs" Inherits="recruiter_login" Title="Untitled Page" %>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" 
                        Font-Size="Large" Font-Underline="True"  NavigateUrl="~/rec_reg.aspx">Registration</asp:HyperLink>
                </td>
            </tr>
        </table>
        &nbsp;</p>
